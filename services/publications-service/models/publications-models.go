...
type Publication struct {
	...
	PublishingCountry  codebookModels.Codebook  `json:"publishingCountry" neo4j:"rel,PublishingCountry,HAS_PUBLISHING_COUNTRY,uid,publishingCountry"` // publishingCountry is the publishing country of the publication
	...
	ExperimentalSystem *codebookModels.Codebook `json:"experimentalSystem" neo4j:"rel,System,HAS_EXPERIMENTAL_SYSTEM,uid,experimentalSystem"`         // experimentalSystem is the experimental system of the publication
}
